...
cargo run --release -- exp1 data/instances_l50 --base-sigma=2 --num-sigma=25 -o results/exp1_s350_l50.csv -s=350
cargo run --release -- exp1 data/instances_l50 --base-sigma=2 --num-sigma=25 -o results/exp1_s500_l50.csv -s=500
